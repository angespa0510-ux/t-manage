  ...
  */
  ...
  return (<div className="space-y-3 pb-10">
    ...
    {subTab==="tax"&&(()=>{const t=calcTax();return(<div className="space-y-3">
      ...
      {hasInvoice&&t.shouhizei.amount>0&&(<div className="rounded-2xl p-4" style={{background:`linear-gradient(135deg,${orange}15,${orange}05)`,border:`2px solid ${orange}44`}}><p className="text-[10px] text-center" style={{color:T.textMuted}}>消費税（{t.shouhizei.method}）</p><p className="text-[24px] font-bold text-center" style={{color:orange}}>{fmt(t.shouhizei.amount)}</p><p className="text-[9px] text-center mt-1" style={{color:T.textMuted}}>売上の約{(t.shouhizei.rate*10/110*100*110/10).toFixed(1)}%相当</p></div>)}
