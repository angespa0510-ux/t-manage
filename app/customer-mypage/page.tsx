        ...
        <div className="rounded-2xl border w-full max-w-[400px] animate-[slideUp_0.3s]" style={{ backgroundColor: C.card, borderColor: C.border }} onClick={e => e.stopPropagation()}>
          {canCancelDirectly(cancelTarget) ? (<>
            ...
            <div className="px-6 py-4">
              ...
              <button onClick={confirmCancel} className="w-full py-3 rounded-xl text-[13px] font-medium cursor-pointer mb-2" style={{ backgroundColor: "#c4555515", color: C.red, border: "1px solid #c4555530" }}>キャンセルを確定する</button>
            ...
            <div className="px-6 py-4">
              ...
              <div className="rounded-xl p-3 mb-4" style={{ backgroundColor: "#c4555508", border: "1px solid #c4555520" }}>
