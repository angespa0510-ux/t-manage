...
const POINTS = [
  {
    num: "01",
    title: "高収入・日払いOK",
    desc: "平均月収80万円以上。経験・実績に応じてどんどん昇給します。日払い・週払いにも対応しております。",
  },
  {
    num: "02",
    title: "未経験でも安心",
    desc: "研修制度が充実。マッサージ技術から接客マナーまで、スタッフが一から丁寧に指導いたします。",
  },
  {
    num: "03",
    title: "自由な働き方",
...
const FAQ = [
  {
    q: "未経験ですが大丈夫ですか？",
    a: "はい、在籍の8割が未経験スタートです。マッサージ技術から接客、当店のサービス内容まで、すべてスタッフが丁寧に研修いたしますのでご安心ください。",
  },
  {
    q: "身バレは大丈夫ですか？",
  ...
  {
    q: "どのくらい稼げますか？",
    a: "平均月収は80万円以上、頑張り次第で月200万円以上稼ぐスタッフもおります。シフトの入り方やリピート獲得のコツについてもサポートいたします。",
  },
  {
    q: "学生やWワークでも働けますか？",
