            ...
            <div className="space-y-3">
              ...
              <div className="rounded-xl p-4" style={{ backgroundColor: T.cardAlt }}>
                ...
                <div className="space-y-1 text-[11px]">
                  ...
                  {giftBack > 0 && <div className="flex justify-between" style={{ color: "#c96b83" }}><span>💝 投げ銭バック</span><span>+{fmt(giftBack)}</span></div>}
...
${giftBack > 0 ? `<tr><td style="color:#c96b83">💝 投げ銭バック</td><td class="right" style="color:#c96b83">+&yen;${giftBack.toLocaleString()}</td><td style="font-size:11px;color:#666">配信投げ銭の換金分</td></tr>` : ""}
