...
<tr><td>基本バック（${tRes.length}件）</td><td class="right">&yen;${totalBack.toLocaleString()}</td><td style="font-size:10px;color:#888">コースバック合計（税込）</td></tr>
${salaryBonus > 0 ? `<tr><td>給料ランク</td><td class="right">+&yen;${salaryBonus.toLocaleString()}</td><td style="font-size:10px;color:#888">${salaryType === "percent" ? salaryAmount + "%UP" : "¥" + salaryAmount.toLocaleString() + "×" + tRes.length + "件"}</td></tr>` : ""}
${totalNom > 0 ? `<tr><td>指名バック</td><td class="right">+&yen;${totalNom.toLocaleString()}</td><td style="font-size:10px;color:#888">指名料（税込）</td></tr>` : ""}
${totalOptBack > 0 ? `<tr><td>オプションバック</td><td class="right">+&yen;${totalOptBack.toLocaleString()}</td><td style="font-size:10px;color:#888">オプション設定バック（税込）</td></tr>` : ""}
${totalExtBack > 0 ? `<tr><td>延長バック</td><td class="right">+&yen;${totalExtBack.toLocaleString()}</td><td style="font-size:10px;color:#888">延長設定バック（税込）</td></tr>` : ""}
...
<tr style="background:#f9f6f0"><td><strong>業務委託報酬（税込）</strong></td><td class="right"><strong>&yen;${backTotal.toLocaleString()}</strong></td><td style="font-size:10px;color:#888">控除前の報酬総額</td></tr>
...
<h3 style="margin-top:25px;font-size:13px">売上明細</h3>
...
<h3 style="margin-top:20px;font-size:13px">支払い方法別</h3>
<table><tr><td>💳 カード</td><td class="right">&yen;${totalCard.toLocaleString()}</td></tr><tr><td>📱 PayPay</td><td class="right">&yen;${totalPaypay.toLocaleString()}</td></tr><tr><td>💴 現金</td><td class="right">&yen;${totalCash.toLocaleString()}</td></tr></table>
