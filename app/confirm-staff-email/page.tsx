      ...
      <div style={{ width: "100%", maxWidth: 400, padding: "40px 32px", backgroundColor: "#ffffff", border: "1px solid #e5ded6", textAlign: "center" }}>
        ...
        {status === "success" && (
          <>
            ...
            <p style={{ margin: 0, fontSize: 12, color: "#555555", letterSpacing: "0.05em", lineHeight: 1.9 }}>{name} さんのメールアドレスが<br />確認されました</p>
        ...
        {status === "already" && (
          <>
            ...
            <div style={{ width: 24, height: 1, backgroundColor: "#6b9b7e", margin: "0 auto 10px" }} />
            <p style={{ margin: 0, fontSize: 12, color: "#555555", letterSpacing: "0.05em", lineHeight: 1.9 }}>{name} さんのメールアドレスは<br />既に確認されています</p>
          </>
        )}
        {status === "error" && (
          <>
