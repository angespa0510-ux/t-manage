...
export const DX_FAQ = [
  ...
  {
    q: "個人事業主や小規模な相談でも対応してもらえますか?",
    a: "もちろんです。「こんなこと、できる?」レベルの初期相談からお受けしています。個人の方のアプリ開発、小さな業務ツールの自動化、LP1枚の制作、AI活用の壁打ちなど、規模の大小を問わずご相談ください。敷居は低く開いています。",
  },
  {
    q: "費用感はどのくらい見ておけば良いですか?",
    a: "Phase 01〜03の診断・提案で180万円前後、実装は規模により240〜800万円、運用は月額18万円〜が目安です。プロダクトは必要な機能だけ選んで導入できるので、初期費用を抑えてスタートすることも可能です。個人案件は都度ご相談でお見積もりします。",
  },
  {
    q: "どのくらいの期間で効果が出ますか?",
