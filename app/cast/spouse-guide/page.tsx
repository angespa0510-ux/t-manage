          ...
          <div className="space-y-1.5">
            {[
              ...
              },
              {
                ...
                a: "Ange Spaではインボイス登録を推奨しています。未登録だとバック額の10%が控除されますが、登録すればこの控除がなくなり手取りが増えます。本名公開が気になる場合は『屋号』で登録できます。詳しくは[page:/mypage/invoice-guide:インボイス登録ガイド]をご覧ください。",
              },
              {
