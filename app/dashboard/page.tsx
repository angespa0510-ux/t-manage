...
export default function Dashboard() {
  ...
  useEffect(() => { const params = new URLSearchParams(window.location.search); const p = params.get("page"); if (p) setActivePage(p); const d = params.get("date"); if (d) setClosingDate(d); }, []);
